classdef frameEncoder
    ...
    methods
        function obj=frameEncoder(frameBody,frameType,referenceFrameBodyF,referenceFrameBodyB)
        ...
        function obj = encodeP(obj,RGB,ref1)
           ...
           for i=1:mbV
               for j=1:mbH
                    frameBody(i,j)=macroblockEncoder(Y((i-1)*16+1:i*16,(j-1)*16+1:j*16),Cb((i-1)*8+1:i*8,(j-1)*8+1:j*8),Cr((i-1)*8+1:i*8,(j-1)*8+1:j*8),'P',j,i,ref1,-1);
               end
           end
           obj.frameBody=frameBody;
        end                              
        ...
        function obj = encodeB(obj,RGB,ref1,ref2)
           ...
           for i=1:mbV
               for j=1:mbH
                    frameBody(i,j)=macroblockEncoder(Y((i-1)*16+1:i*16,(j-1)*16+1:j*16),Cb((i-1)*8+1:i*8,(j-1)*8+1:j*8),Cr((i-1)*8+1:i*8,(j-1)*8+1:j*8),'P',j,i,ref1,ref2);
               end
           end
           obj.frameBody=frameBody;
        end   
