function [pErr]=ModelQ87b(N,y,Fs,NPart,NExtZeros,window,blockType,b0,b1,FileName,Smoothing)

tic;

wavwrite(y,Fs,16,[FileName 'Intput67.wav']);


[z,bits]=insertRandBitsModQ87(N,y,Fs,b0,b1,Smoothing);
...
wavwrite(z,Fs,16,[FileName 'Output67.wav']);
