function [pErr]=ModelQ66b(N,y,NPart,NExtZeros,window,blockType,h0,h1,FileName,Fs,Smoothing)

tic;



wavwrite(y,Fs,16,[FileName 'Intput66.wav']);


[z,bits]=insertRandBitsModQ66(y,N,h0,h1,NPart,Smoothing);
...
wavwrite(z,Fs,16,[FileName 'Output66.wav']);
