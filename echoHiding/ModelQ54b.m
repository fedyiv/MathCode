function [ gamma ] = ModelQ54b(N1gsh, N0,N2,dN,h,NExperiments)
...
for j=1:Np
    ...
    for i=1:NExperiments
        ...
        z=[z(1:N1gsh) zeros(1,N0-N1gsh+(j-1)*dN)];
...
print(hh,'-dpng',['d:\\work\\bNExp' num2str(NExperiments) 'Ngn' num2str(N1gsh)] );
