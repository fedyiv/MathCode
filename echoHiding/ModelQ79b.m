function [ ] =ModelQ79b(Ngsh,h0,h1,blockType,L,NExp)
...
for i=1:Np
    ...
    [pErrR(i) ~]=ModelQ79a(Ngsh,h0,h1,L(i),blockType,'none',NExp,round(2*(Ngsh/L(i))));
    [pErrExp(i) ~]=ModelQ79a(Ngsh,h0,h1,L(i),blockType,'exp',NExp,round(2*(Ngsh/L(i))));
    [pErrHann(i) ~]=ModelQ79a(Ngsh,h0,h1,L(i),blockType,'hann',NExp,round(2*(Ngsh/L(i))));
    [pErrHamm(i) ~]=ModelQ79a(Ngsh,h0,h1,L(i),blockType,'hamm',NExp,round(2*(Ngsh/L(i))));
