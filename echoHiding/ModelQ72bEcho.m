function [pErr]=ModelQ72bEcho(N,y,Fs,NPart,NExtZeros,window,blockType,b0,b1,FileName,Smoothing,hAttack)
...
[z]=insertBitsModQ77(N,y,bits,b0,b1,Smoothing);
