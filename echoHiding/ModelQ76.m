function [n kChangable mEmbedded]=ModelQ76(N,y,Fs,NPart,NExtZeros,window,blockType,b0,b1,FileName,Smoothing,wpcN,wpcNH,wpcControl,wpcH)
...
[z]=insertBitsModQ76(N,y,outCover,b0,b1,Smoothing,mask);
...
wavwrite(z,Fs,16,[FileName 'Output76.wav']);
