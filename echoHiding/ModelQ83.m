function [ ] =ModelQ83(Ngsh,h0,h1,blockType,L,NExp)
...
for i=1:Np
    ...
    [pErrR(i) ~]=Model82(Ngsh,h0,h1,L(i),blockType,'none',NExp,floor(2*(Ngsh/L(i))));
    [pErrExp(i) ~]=Model82(Ngsh,h0,h1,L(i),blockType,'exp',NExp,floor(2*(Ngsh/L(i))));
    [pErrHann(i) ~]=Model82(Ngsh,h0,h1,L(i),blockType,'hann',NExp,floor(2*(Ngsh/L(i))));
    [pErrHamm(i) ~]=Model82(Ngsh,h0,h1,L(i),blockType,'hamm',NExp,floor(2*(Ngsh/L(i))));
