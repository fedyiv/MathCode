function Bit = extractBit2PosCepsPreobr( Mass,Fs,N1,N2,a,n0,dn0,Npart,NExtZeros,window,blockType)
...
%        h0=[1 zeros(1,n0-1) a];
   ...
   %h0=[1 zeros(1,n0+floor(dn0/2)-1) a zeros(1,n0+floor(3*dn0/2)-1)];
    ...
    h1=[1 zeros(1,n0-1) a zeros(1,dn0-1) -a zeros(1,dn0-1) a zeros(1,dn0-1) -a];

    h0=[1 zeros(1,n0-1) -a zeros(1,dn0-1) a  zeros(1,dn0-1) -a zeros(1,dn0-1) a];
