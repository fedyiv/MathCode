function [  ] = HugoEmulateEmbeddingJ2g(alpha,dim,T,model_correction,directorySource,directorySG,ext,sigma,gamma,weightForm,weightMatrix,sign,h)
...
% another difference is that matrix H_hat is generated once for whole image
% set
