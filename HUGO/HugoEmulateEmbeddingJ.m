function [  ] = HugoEmulateEmbeddingJ(alpha,dim,T,model_correction,directorySource,directorySG,ext,sigma,gamma,weightForm,weightMatrix)
...
for i=1:N
   ...
   % im1=im1(1:5,1:5);
    ...
    Costs=HugoGetCostsCacheJ(list{i},dim,T,sigma,gamma,weightForm,weightMatrix);
