function [  ] = HugoEmulateEmbeddingJ3(alpha,dim,T,model_correction,directorySource,directorySG,ext,sigma,gamma,weightForm,weightMatrix,sign,probability)
...
if(numel(costsList)~=N)
    hugoExecutor=HugoExecutor(5,directorySource,dim,T,gamma,sigma,weightForm,weightMatrix,sign,probability);
...
for i=1:N
   ...
   % im1=im1(1:5,1:5);
    ...
    Costs=HugoGetCostsCacheJ3(list{i},dim,T,sigma,gamma,weightForm,weightMatrix,sign,probability);
