function [P minPfa minPm] = HugoModel1svmgrid2(directoryCMtrain,directorySGtrain,directoryCMtest,directorySGtest,ext,dim,T,sigma,boxconstraint,cross_val,visual)
