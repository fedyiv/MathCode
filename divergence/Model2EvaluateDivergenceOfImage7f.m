function [ DivXY DivYX pE] = Model2EvaluateDivergenceOfImage7f( directoryCM,ext,dim,T,pEmb,visual,stegosys,amplitude,blkLen,h)
...
k=1;
for i=h
    [ DivXY(k) DivYX pE] = Model2EvaluateDivergenceOfImage6f( cmDirWhite,cmDirBlack,ext,dim,T,pEmb,visual,stegosys,amplitude,i);
    k=k+1;
    h
    DivXY
end
