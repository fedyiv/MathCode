function [ DivXY DivYX pE] = Model2EvaluateDivergenceOfImage7e( directoryCM,ext,dim,T,pEmb,visual,stegosys,amplitude,blkLen)
...
k=1;
for i=pEmb
    [ DivXY(k) DivYX pE] = Model2EvaluateDivergenceOfImage6e( cmDirWhite,cmDirBlack,ext,dim,T,i,visual,stegosys,amplitude);
    k=k+1;
end
end
