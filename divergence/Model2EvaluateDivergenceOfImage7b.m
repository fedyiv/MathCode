function [ DivXY DivYX pE] = Model2EvaluateDivergenceOfImage7b( directoryCM,ext,dim,T,pEmb,visual,stegosys,amplitude,blkLen)
...
k=1;
for i=pEmb
    [ DivXY(k) DivYX pE] = Model2EvaluateDivergenceOfImage6( cmDirWhite,cmDirBlack,ext,dim,T,i,visual,stegosys,amplitude);
    k=k+1;
end
end
