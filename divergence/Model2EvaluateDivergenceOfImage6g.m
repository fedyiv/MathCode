function [ DivXY DivYX pE] = Model2EvaluateDivergenceOfImage6g( directoryCM,directoryCM2,ext,dim,T,pEmb,visual,stegosys,amplitude,h)
...
% Also uses HugoEmulateEmbeddingJ2g, that generates one h_hat matrix for
% all images
...
elseif(strcmp(stegosys,'hugo'))
    ...
    HugoEmulateEmbeddingJ2g(pEmb,dim,T,0,cmDir,sgDir,ext,10,4,1,0,0,h)
