function [ DivXY DivYX pE] = Model2EvaluateDivergenceOfImage4gridLSBMatch2( directoryCM,ext,dim,T,blockLen,pEmb,visual)
...
for i=1:N
    ...
    for p=pEmb
        ...
        evalc('eurModel3emulateLSBmatching2(p,cmDir,sgDir,ext)');
