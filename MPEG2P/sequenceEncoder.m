classdef sequenceEncoder
    ...
    methods
        function  obj=sequenceEncoder(inputSequence,outputFileName,gopParam,isPMO)
        ...
        function obj = saveNextGop(obj,gopParam,inputSequence)
            ...
            gop=gopEncoder(gopParam,inputSequence(:,:,:,(iGop-1)*gopParam(1)+1:iGop*gopParam(1)),obj.isPMO);
        ...
        function obj=addGop(obj,inputSequence)
            ...
            gop=gopEncoder(obj.gopParam,inputSequence,obj.isPMO);
            fwrite(obj.fid,numel(gop.gbs),'uint64');
            fwrite(obj.fid,gop.gbs,'uint16');
